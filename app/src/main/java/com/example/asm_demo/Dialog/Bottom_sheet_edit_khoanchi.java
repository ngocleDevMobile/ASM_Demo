...
public class Bottom_sheet_edit_khoanchi extends BottomSheetDialogFragment {
    ...
    public Bottom_sheet_edit_khoanchi() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottom_sheet_edit_khoanchi, container, false);
